...
typedef
	struct {
		...
		int       rcvstate;        // State Machine state
		int       recvpin;         // Pin connected to IR data from detector
		int       blinkpin;
		int       blinkflag;       // true -> enable blinking of pin on IR processing
		int       rawlen;          // counter of entries in rawbuf
		unsigned int  rawbuf[RAWBUF];  // raw data
		int       overflow;        // Raw buffer overflow occurred
	}
irparams_t;
